...
export interface ApiCustomApiCustomApi extends Struct.CollectionTypeSchema {
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    name: Schema.Attribute.String;
    description: Schema.Attribute.Text;
    update_status: Schema.Attribute.String;
...
export interface ApiRegistrationRegistration
  ...
  attributes: {
    ...
    socialSecurityNumber: Schema.Attribute.BigInteger;
    email: Schema.Attribute.Email;
    ...
    approver: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    label: Schema.Attribute.Enumeration<['approved', 'pending', 'rejected']>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSubmissionSubmission extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    proofOfWork: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    label: Schema.Attribute.Enumeration<['pending', 'approved', 'declined']>;
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    label: Schema.Attribute.Enumeration<
      ['completed', 'not_completed', 'rejected']
    >;
    image_url: Schema.Attribute.String;
    rejection_comment: Schema.Attribute.String;
    deadline: Schema.Attribute.Date;
    qa: Schema.Attribute.String;
    qc: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::custom-api.custom-api': ApiCustomApiCustomApi;
